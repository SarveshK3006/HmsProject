...
<div class="container">
    ...
    <div class="prescription">
      <p style="margin-left:15px;font-size:10px;font-weight:bold;">Rx  <%=details.getPatientName() %></p>    
        <table>
     <tr>
      <th></th>
       <th>Type</th>
    ...
    <p style="font-size:9px;text-align:right;padding-bottom:15px;padding-right:25px;">Dr.Shrinivas Kulkarni</p>
  </div>
